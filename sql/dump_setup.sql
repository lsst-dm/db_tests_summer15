...
-- Extract IDs for Stripe82 deep sources in such a level 8 HTM triangle.
CREATE TABLE qserv_in2p3_2015.DeepSourceIds (deepSourceId BIGINT NOT NULL PRIMARY KEY) AS
SELECT deepSourceId
